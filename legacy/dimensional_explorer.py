...
from core_measures import PHI, PI, PSI, VARPI, DimensionalMeasures
...
class DimensionalExplorer:
    ...
    def create_interface(self):
        ...
        self.fig.suptitle(
            "Dimensional Emergence Framework Explorer", fontsize=16, fontweight="bold"
        )
...
R(s→t) = [Λ(t)-|ρ_t|]/[t-s+φ]
    ...
    def show_constants(self, event):
        ...
        fig_const.suptitle(
            "Dimensional Constants Explorer", fontsize=14, fontweight="bold"
        )
