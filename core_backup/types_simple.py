...
class MeasureValue:
    ...
    def __init__(
        self, value: float, dimension: DimensionalParameter, measure_type: str
    ):
        self.value = float(value)
...
class VolumeFunction:
    ...
    def __call__(self, d: Union[float, DimensionalParameter]) -> MeasureValue:
        ...
        return MeasureValue(value=volume, dimension=dim, measure_type="volume")
...
class SurfaceFunction:
    ...
    def __call__(self, d: Union[float, DimensionalParameter]) -> MeasureValue:
        ...
        return MeasureValue(value=surface, dimension=dim, measure_type="surface")
...
class ComplexityFunction:
    ...
    def __call__(self, d: Union[float, DimensionalParameter]) -> MeasureValue:
        ...
        return MeasureValue(value=complexity, dimension=dim, measure_type="complexity")
