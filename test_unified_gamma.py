...
class TestCoreGammaFunctions:
    ...
    def test_gamma_large_values(self):
        ...
        assert np.isfinite(large_val) or np.isinf(large_val)  # Either finite or properly infinite
...
def run_manual_tests():
    ...
    try:
        ...
        print("\n🎉 ALL TESTS PASSED!")
        print(f"✨ Unified gamma module successfully consolidates all features!")
