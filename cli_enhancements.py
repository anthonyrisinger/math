...
def main_callback(
    ...
    json_output: bool = typer.Option(False, "--json", help="Force JSON output globally"),
...
def generate_completion(shell: str = typer.Argument(..., help="Shell type: bash, zsh, fish")):
...
def cli_batch(
    ...
    output_dir: Optional[str] = typer.Option(None, "--output-dir", help="Directory for outputs")
):
